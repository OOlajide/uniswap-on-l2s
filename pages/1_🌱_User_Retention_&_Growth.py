...
st.info("This page dissects user retention rates and growth patterns across Uniswap. Understanding how users persist on different chains.", icon="ℹ️")
