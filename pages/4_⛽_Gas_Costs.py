...
insight_2 = '<p style="font-family:sans-serif; color:#4d372c; font-size: 18px;">Polygon stands out as the most economical chain, boasting the lowest average gas cost and the lowest average gas cost for swapping $1. This cost efficiency likely contributes to Polygon\'s dominance, evident in its significantly higher number of active pools compared to other chains. On the flip side, Optimism and Avalanche emerge as the costliest chains with an average gas cost of $0.5 each.</p>'
